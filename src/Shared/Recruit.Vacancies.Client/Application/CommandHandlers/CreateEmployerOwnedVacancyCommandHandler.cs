...
{
    public class CreateEmployerOwnedVacancyCommandHandler: IRequestHandler<CreateEmployerOwnedVacancyCommand, Guid>
    {
        ...
        public async Task<Guid> Handle(CreateEmployerOwnedVacancyCommand message, CancellationToken cancellationToken)
        {
