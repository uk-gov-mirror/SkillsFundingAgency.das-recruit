...
public interface IRecruitVacancyClient
{
    ...
    Task<PagedResults<VacancyApplication>> GetVacancyApplicationsAsync(VacancyApplicationsPagingParams pagingParams, long vacancyReference, bool vacancySharedByProvider = false);
